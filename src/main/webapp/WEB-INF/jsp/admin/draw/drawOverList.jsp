...
<div class="row">
    <div class="col-xs-12">
        <form action="drawOverList" id="form" name="form" method="post">
            ...
            />
            操作时间:
            <input type="text" id="stTime" name="stTime" size="16" class="form_datetime" value="${stTime}"
                   onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"
            />—
            <input type="text" id="enTime" name="enTime" size="16" class="form_datetime" value="${enTime}"
                   onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"
            />
